                            ...
                            <div className="mt-8 max-w-md mx-auto">
                                ...
                                <div className="mt-4 space-y-3">
                                    ...
                                    <button
                                        ...
                                        className="w-full flex items-center justify-center px-4 py-3 border border-white/30 text-sm font-medium rounded-md text-white bg-transparent hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
                                    >
                                        <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="currentColor">
